      ...
      >
        {servicesinfo.map((item, index) => (
          ...
          >
            ...
            <p className="font-ubuntu text-[18px] text-slate-200">
              {item.about}
            </p>
            <button className="text-flamered font-ubuntu font-semibold text-[18px] flex justify-center items-center gap-3">
              {item.label}
              <FaArrowRight />
            </button>
          </div>
