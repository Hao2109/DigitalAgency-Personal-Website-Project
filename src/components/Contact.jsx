  ...
  "
    >
      ...
      <div
        data-aos="zoom-in"
        data-aos-delay="400"
        className="lg:w-[50%] w-full flex flex-col justify-center items-start gap-8 bg-black lg:p-16 p-8 rounded-3xl "
      >
        ...
        >
          ...
          <textarea
            ...
            rows="4"
          ></textarea>
          <button className="bg-limegreen px-6 py-4 w-full rounded-md font-semibold text-md font-ubuntu">
            Submit Now
          </button>
        </div>
      </div>
